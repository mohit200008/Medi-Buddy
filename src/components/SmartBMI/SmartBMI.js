        ...
        {page1 ? (
          <div className="bmi__firstPage">
            ...
            <div className="bmi__imgContainer">
              <img src={"/images/fitness.jpg"} alt="img1" />
            </div>
          </div>
        ) : (
            ...
            <div className="bmi__resultContainer">
              <div className="bmi__resultHeader">
                <div className="bmi__inputData">
                  <div>
                    <img src={"/images/age.svg"} alt="img2" />
                    <p>{age} years</p>
                  </div>
                </div>
                <div className="bmi__inputData">
                  <div>
                    <img src={"/images/height.svg"} alt="img3" />
                    <p>{height} cm</p>
                  </div>
                </div>
                <div className="bmi__inputData">
                  <div>
                    <img src={"/images/scale.svg"} alt="img4" />
                    <p>{weight} kg</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bmi__waterContainer">
                <img src={"/images/water.svg"} alt="img5"/>
