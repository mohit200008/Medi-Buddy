    ...
    <>
      ...
      <div className="blog-card">
        ...
        <div className="description">
          ...
          <button><a href="https://breastcancerdetectionweb.herokuapp.com/" target='_blank' style={{ textDecoration: "none", fontSize:'25px' }}>
            Predict</a>
          </button>
        </div>
      </div>
      ...
      <div className="blog-card alt">
        ...
        <div className="description">
          ...
          <button><a href="https://diabetiespredictionweb.herokuapp.com/" target='_blank' style={{ textDecoration: "none", fontSize:'25px' }}>
            Predict</a>
          </button>
        </div>
      </div>
      ...
      <div className="blog-card">
        ...
        <div className="description">
          ...
          <button><a href="https://heartdiseasepredictionweb.herokuapp.com/" target='_blank' style={{ textDecoration: "none", fontSize:'25px' }}>
            Predict</a>
          </button>
        </div>
      </div>
      ...
      <div className="blog-card alt">
        ...
        <div className="description">
          ...
          <button><a href="https://kidneydiseasepredictionweb.herokuapp.com/ " target='_blank' style={{ textDecoration: "none", fontSize:'25px' }}>
            Predict</a>
          </button>
        </div>
      </div>
